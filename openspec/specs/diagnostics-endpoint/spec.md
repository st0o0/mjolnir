...
Define the diagnostics HTTP endpoint that exposes all NUT variables with their handling classification, enabling operators to see which variables are handled by which metric type and which remain unhandled.
