...
Define the Go binary entrypoint (`mjolnir`) that replaces `entrypoint.sh`: ENV parsing, NUT config generation, daemon lifecycle, signal handling, static compilation, and version reporting.
