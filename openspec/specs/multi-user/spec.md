...
Define how mjolnir discovers, validates, and configures multiple NUT users from environment variables, supporting both indexed multi-user and legacy single-user modes.
