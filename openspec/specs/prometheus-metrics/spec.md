...
Define the Prometheus metrics endpoint: UPS telemetry gauges collected by polling `upsc`, exposed at `:9550/metrics` with per-UPS labels for multi-UPS support.
