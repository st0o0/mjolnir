...
#### Scenario: Non-numeric variable
- **WHEN** NUT reports `ups.firmware="FW:2.0"` (not parseable as float)
- **THEN** no `mjolnir_ups_firmware` metric is created (silently skipped)
